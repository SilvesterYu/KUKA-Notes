...
- or the Camera , I am planning to use an Intel D455i camera on the KUKA arm, as recommended by Prof. Tzes. May I know if the lab has it? and if it is, is there a ROS package that the lab is using?
